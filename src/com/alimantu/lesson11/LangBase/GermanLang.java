...
public class GermanLang {
    private static final String DB_NAME = "GermanLang";
    private static final int DB_VERSION = 16;
    private static final String DB_TABLE = "de_level";
    ...
    public GermanLang(Context context)
    {
    ...
    public void addDefault() {
        addChannel(context.getString(R.string.de_animals), startRate);
        addChannel(context.getString(R.string.de_body), startRate);
        addChannel(context.getString(R.string.de_sport), startRate);
        addChannel(context.getString(R.string.de_colour), startRate);
        addChannel(context.getString(R.string.de_fru_veg), startRate);
        addChannel(context.getString(R.string.de_countr), startRate);
        addChannel(context.getString(R.string.de_prof), startRate);
        addChannel(context.getString(R.string.de_weather), startRate);
        addChannel(context.getString(R.string.de_nature), startRate);
        addChannel(context.getString(R.string.de_music), startRate);
    }
