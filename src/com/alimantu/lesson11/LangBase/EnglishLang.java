...
public class EnglishLang {
    private static final String DB_NAME = "EnglishLang";
    private static final int DB_VERSION = 16;
    private static final String DB_TABLE = "eng_level";
    ...
    public final static int startRate = 11;

    public EnglishLang(Context context)
    {
    ...
    public void addDefault() {
        addChannel(context.getString(R.string.eng_animals), startRate);
        addChannel(context.getString(R.string.eng_body), startRate);
        addChannel(context.getString(R.string.eng_sport), startRate);
        addChannel(context.getString(R.string.eng_colour), startRate);
        addChannel(context.getString(R.string.eng_fru_veg), startRate);
        addChannel(context.getString(R.string.eng_countr), startRate);
        addChannel(context.getString(R.string.eng_prof), startRate);
        addChannel(context.getString(R.string.eng_weather), startRate);
        addChannel(context.getString(R.string.eng_nature), startRate);
        addChannel(context.getString(R.string.eng_music), startRate);
    }
