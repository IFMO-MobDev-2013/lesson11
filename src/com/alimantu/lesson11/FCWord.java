 ...
 */
public class FCWord extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fc_word);
        ...
        fromText = (TextView) findViewById(R.id.using_word);
        toText = (TextView) findViewById(R.id.target_word);
        yes = (Button) findViewById(R.id.word_yes);
        no = (Button) findViewById(R.id.word_no);

        Collections.shuffle(result);
        setPicture(result.get(count), true);

        imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toText.setText(getFromLanguage(result.get(count)));
                setPicture(result.get(count), false);
                yes.setEnabled(true);
    ...
    private void setPicture(DictElem word, boolean blured) {
        ...
        fromText.setText(getToLanguage(word));
    }
